# WebGPU Basics: Hello, WebGPU!

This branch showcases basic WebGPU initialization.
...
For a detailed explanation of the implementation, check out the blog post: [WebGPU Basics: Hello, WebGPU!](https://danilosdev.blog/it/blog/webgpu-basics/01-hello).
